...
#os.chdir("C:/Data/phil/etude/FEDER_tatouwave/stagiaire/code")


from wavelet2D import makeonfilter
from wavelet2D import Lire_Echelle_Mallat2D
from wavelet2D import Ecrire_Echelle_Mallat2D
from wavelet2D import banc_filtre2d
import time
...
def decomposition_image(img,nb_echelles,echelle,plan):
    ...
    Returns
    -------
    WR : renvoie les coefficients d'ondelltes'
    """
    ...
    wctest = banc_filtre2d(0,Gris,nb_echelles,f)    #le 3ème chiffre correspond au nombre d'échelles, le 4ème au plan
    #plt.imshow(wctest)
